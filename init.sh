...
evmosd add-genesis-account $KEY2 100000000000000000000000000aphoton --keyring-backend $KEYRING
# Sign genesis transaction
evmosd gentx $KEY 1000000000000000000000aphoton --keyring-backend $KEYRING --chain-id $CHAINID
evmosd gentx $KEY2 1000000000000000000000aphoton --keyring-backend $KEYRING --chain-id $CHAINID
